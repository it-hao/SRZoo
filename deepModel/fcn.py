...
# --------------------------------------------------------------------------------------------------
# this is a implementation of FC2N: Fully Channel-Concatenated Network for Single Image Super-Resolution
# The official code is implemented by TensorFlow: https://github.com/zxlation/FC2N
