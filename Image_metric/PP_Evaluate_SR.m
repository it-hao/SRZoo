...
mu2_SR = mu2.*mu2;
mu1_mu2 = mu1.*mu2;
sigma1_SR = filter2(window, img1.*img1, 'valid') - mu1_SR;
sigma2_SR = filter2(window, img2.*img2, 'valid') - mu2_SR;
sigma12 = filter2(window, img1.*img2, 'valid') - mu1_mu2;

if (C1 > 0 & C2 > 0)
    ssim_map = ((2*mu1_mu2 + C1).*(2*sigma12 + C2))./((mu1_SR + mu2_SR + C1).*(sigma1_SR + sigma2_SR + C2));
else
    numerator1 = 2*mu1_mu2 + C1;
    numerator2 = 2*sigma12 + C2;
    denominator1 = mu1_SR + mu2_SR + C1;
    denominator2 = sigma1_SR + sigma2_SR + C2;
