...
'''
    This is PyTorch implementation of Paper: 'MemNet: A Persistent Memory Network for Image Restoration'. 
    The official code is based on Caffe and the github is https://github.com/tyshiwo/MemNet. 
'''
